...
q2_data |>
  ...
  labs(title = "Goal differential has a positive correlation
       ...
       y = "") +
  theme(plot.subtitle = element_text(size = 0.1)) +
  theme_minimal() +
