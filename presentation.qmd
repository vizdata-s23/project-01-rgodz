...
#   ggplot(aes(x=appearances, y=reorder(team, goal_diff), fill=goal_diff)) +
#   geom_col(show.legend = FALSE) +
#   labs(title = "Goal differential has a positive correlation
#        with final four appearances",
#        subtitle = "Color scaled by goal differential (listed after each bar)",
#        x = "Final four appearances",
#        y = "") +
#   theme_minimal() +
#   scale_fill_gradient2(low = "lightblue", mid = "blue", high = "darkblue", midpoint = 50) +
#   # Add in goal differential numbers
#   geom_text(aes(x=appearances + 0.5, y=team, label=goal_diff), size=3, color="black", fontface='bold') +
#   scale_x_continuous(
#     breaks = c(
#       3,
#       4,
